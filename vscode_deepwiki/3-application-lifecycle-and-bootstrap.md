...
For information about the workbench UI framework initialized after bootstrap, see [Workbench Architecture](/microsoft/vscode/5-workbench-architecture). For extension host initialization specifically, see [Extension System](/microsoft/vscode/6-extension-system).
