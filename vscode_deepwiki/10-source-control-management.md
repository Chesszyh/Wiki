...
The SCM system uses a dual-process architecture where extensions run in an isolated Extension Host process and communicate with the main UI thread through RPC.
...
The SCM system uses VS Code's menu contribution system extensively, with many menu IDs for different contexts.
